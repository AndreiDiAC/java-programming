...
public class Book {
    ...
    /**
     ...
     - The method returns false => if word parameter is one of articles, coordinate conjunctions, or prepositions.
     See full list below
    ...
    public static Boolean isTitleWord(String word) {
        String [] list = new String[] {"a","an","the","and", "but", "for", "nor", "or", "so", "yet",
                "at", "by", "in", "into", "near", "of", "on", "to", "than", "via"};
    ...
    public void setAuthor(String author) {
        ...
        if(author.isEmpty()){
            ...
            this.author = result.substring(0,result.length()-1);
        }
    }
...
//                    }
//                }
//                this.title = result.substring(0,result.length()-1);
//            }
